...
export async function deleteArticleById(id) {
  ...
  try {
    console.log(`[ArticleStore deleteArticleById] 正在嘗試刪除 JSON 檔案: ${articleJsonFilePath}`);
  ...
  console.log(`[ArticleStore deleteArticleById] 文章 ${id} 刪除流程完成。返回: ${jsonDeleted}`);
  return jsonDeleted;
}
